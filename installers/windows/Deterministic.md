...
* Build using Inno Setup and the `Italo.iss` script file
...
Note that the the following line in `Italo.iss` is also important regarding file timestamps:
