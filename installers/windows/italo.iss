; Italo Lithium Luna GUI Wallet Installer for Windows
...
; As of version 0.12.3.0, the Italo .exe files do not carry version info anyway in their .exe headers.
...
begin
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\italocoin-project\italo-core', 'blockchainDataDir', blockChainDir);
...
Name: "{userdesktop}\GUI Wallet"; Filename: "{app}\italo-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\italocoin-project\italo-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\italocoin-project\italo-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
