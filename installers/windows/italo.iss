; Italo Nitrogen Nebula GUI Wallet Installer for Windows
...
DefaultDirName={commonpf}\Italo GUI Wallet
...
; Italo CLI wallet
Source: "bin\extras\italo-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Italo wallet RPC interface implementation
Source: "bin\extras\italo-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\extras\italo-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\italo-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
