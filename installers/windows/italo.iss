; Italo Boron Butterfly GUI Wallet Installer for Windows
...
; As of version 0.14.1.0, the Italo .exe files do not carry version info anyway in their .exe headers.
