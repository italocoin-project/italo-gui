...
<context>
    ...
    <message>
        ...
        <translation>Αυτό διευκολύνει την αποστολή ή λήψη του Italo και μειώνει τα σφάλματα κατά τη μη αυτόματη πληκτρολόγηση διευθύνσεων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ΠΡΟΣΟΧΗ: Μην επαναχρησιμοποιείτε τα κλειδιά του Italo σε άλλο fork, ΕΚΤΟΣ κι αν αυτό το fork χρησιμοποιεί ενσωματωμένους μετριασμούς. Κάνοντας το αυτό θα βλάψει την ιδιωτικότητά σας.</translation>
    </message>
    <message>
        ...
        <translation>ΠΡΟΣΟΧΗ: Αντιγράφοντας το seed σας στο πρόχειρο μπορεί να σας εκθέσει σε κακόβουλο λογισμικό, το οποίο μπορεί να καταγράψει το seed σας και να κλέψει τα Italo σας. Παρακαλώ σημειώστε το seed σας χειροκίνητα. </translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Italo. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Η εξόρυξη με τον υπολογιστή σας βοηθά στην ενίσχυση του δικτύου Italo. Όσο περισσότεροι άνθρωποι βοηθάν στην εξόρυξη, τόσο πιο δύσκολο είναι μια πιθανή επίθεση κατά του δικτύου, οπότε κάθε μικρή βοήθεια είναι χρήσιμη. 

Η εξόρυξη σας δίνει επίσης μια μικρή ευκαιρία να κερδίσετε Italo. Ο υπολογιστής σας θα δημιουργήσει hashes αναζητώντας λύσεις block. Εάν βρείτε ένα block, θα λάβετε τη σχετική ανταμοιβή. Καλή τύχη!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ενσωματωμένη έκδοση Italo: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Χρησιμοποιεί διακομιστή από τρίτο πάροχο για τη σύνδεση στο δίκτυο του Italo. Λιγότερο ασφαλές, αλλά ευκολότερο στον υπολογιστή σας.</translation>
    </message>
    <message>
        ...
        <translation>Για την εύρεση απομακρυσμένου κόμβου, εισάγετε &apos;Italo remote node&apos; στην αγαπημένη σας μηχανή αναζήτησης. Παρακαλώ διαβεβαιώστε πως ο κόμβος λειτουργεί μέσω αξιόπιστου τρίτου παρόχου.</translation>
    </message>
    <message>
...
your input may be required.</source>
    ...
    <message>
        ...
        <translation>Αυτή η διεύθυνση έλαβε %1 italo, αλλά η συναλλαγή δεν εξορύχθηκε ακόμα</translation>
    </message>
    <message>
