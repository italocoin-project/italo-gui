...
<context>
    ...
    <message>
        ...
        <translation>あなたのコンピュータでマイニングを行うことで、Italoのネットワークをより強固にすることができます。マイニングをする人が増えるほど、ネットワークへの攻撃が難しくなります。一人一人の協力が大切です。&lt;br&gt; &lt;br&gt;マイニングをすると、低確率ですがItaloを獲得できる可能性があります。あなたのコンピュータは、ある計算問題の解となるブロックとそのハッシュ値を計算します。正解のブロックが見つかると、あなたはそれに伴う報酬を得ます。グッドラック!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Italoのブロックチェーンを初期化しますか？</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ディスク容量節約モードを有効にすると、使用するディスク容量はずっと小さくなりますが、通信帯域の使用量は通常モードと変わりません。ただし、Italoのネットワークの安全性を高める意味で、完全なブロックチェーンの全体を保存することが推奨されています。もしあなたのコンピュータのディスク容量が小さい場合は、このオプションを使用してください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Italoの採掘をすることでネットワークの安全性が高まり、また提供した計算量の対価として低い確率ですが報酬が得られます。このオプションは、あなたのコンピュータが電源に接続されていてなおかつアイドル状態の場合に、自動的にItaloの採掘を行うことを許可します。あなたが作業を再開すると、採掘は停止されます。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Italoネットワークと通信するためにウォレットはItaloノードに接続されている必要があります。プライバシーを最大限に保護するため自分自身のノードを走らせることが推奨されています。
...
<context>
    ...
    <message>
        ...
        <translation>Italoの開発は寄付のみによって支えられています</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをItaloの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 XTAであった場合、0.0025 XTAが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
...
金額: </translation>
    ...
    <message>
        ...
        <translation>新しいバージョンのitalo-wallet-guiを入手できます: %1&lt;br&gt;%2</translation>
    </message>
    <message>
