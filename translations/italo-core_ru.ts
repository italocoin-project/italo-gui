...
<context>
    ...
    <message>
        ...
        <translation>Это облегчит отправку и получение Italo и снизит количество ошибок при ручном вводе адресов.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПРЕДУПРЕЖДЕНИЕ: Не используйте повторно свои ключи Italo на другом форке, ЕСЛИ ТОЛЬКО этот форк не имеет встроенные средства защиты от компрометации введенных ключей. Подобные действия могут повредить вашей конфиденциальности.</translation>
    </message>
    <message>
        ...
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши Italo могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Italo. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть Italo. Чем больше людей майнят, тем сложнее атаковать сеть, каждый может помочь.

Майнинг также даёт маленький шанс получить Italo. Ваш компьютер будет создать хеши в поиске решения блока. Если вы найдёте блок, то получите награду. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Italo: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети Italo. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных нод, введите &apos;Italo remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранной ноде можно доверять.</translation>
    </message>
    <message>
...
Вы можете изменить пароль в настройках кошелька.</translation>
    ...
    <message>
        ...
        <translation>Получайте Italo для вашего бизнеса, легко.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Italo или их клонов, которые смогут повторно использовать ключи Italo.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Italo потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Italo.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Italo и доступен на веб-сайте getitalo.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн Italo (и его клонов) самостоятельно, используя инструмент italo-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями Italo, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей Italo позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от Italo-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши Italo безопасно.&lt;br&gt;Если вы не используете программное обеспечения от Italo-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Italo, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Italo (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Пожалуйста, обновитесь или подключитесь к другому демону</translation>
    ...
    <message>
        ...
        <translation>Отправляемая сумма: %1 XTA. Пожалуйста, подождите ~%2 минут чтобы весь ваш баланс стал доступен для отправки.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Потратить XTA из оффлайн кошелька</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Доступна новая версия Italo v%1.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit getitalo.org for details</source>
        <translation>Пожалуйста посетите getitalo.org для подробной информации</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Чтобы иметь возможность обмениваться данными с сетью Italo, ваш кошелек должен быть подключен к ноде Italo. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Кроме того, вы можете указать ноду быстрой загрузки, чтобы немедленно начать пользоваться Italo.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Italo</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выберете эту опцию, если вы впервые пользуетесь Italo.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку Italo.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Временное использование удаленных нод полезно для немедленного использования Italo (отсюда название &quot;начальной загрузки&quot;), однако помните, что при использовании удаленных узлов (включая настройку ноды начальной загрузки), узлы могут отслеживать ваш IP адрес, отслеживать вашу &quot;высоту восстановления&quot; и соответствующие данные запроса блока, и отправлять вам неточную информацию, чтобы узнать больше о совершаемых вами транзакциях.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот режим идеально подходит для управления небольшими суммами Italo. У вас есть доступ к основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети Italo, чтобы вы сразу могли начать использовать Italo.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы иметь возможность обмениваться данными с сетью Italo, ваш кошелек должен быть подключен к ноде Italo. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.
...
может требоваться ваше подтверждение.</translation>
    ...
    <message>
        ...
        <translation>Italo успешно отправлены: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 XTA, с %2 подтверждениями.</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1065"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 XTA, но транзакции все еще не подтверждены майнерами</translation>
    </message>
    <message>
