...
<context>
    ...
    <message>
        ...
        <translation>挖矿可增进 Italo 网络的安全性, 越多使用者的挖矿活动, Italo 网络就会越难以被攻击. &lt;br&gt; &lt;br&gt;挖矿也让您有机会赚取额外的门罗币, 您的计算机将持续创建哈希值用以寻找区块, 如找到则可以获得该区块所附带的门罗币奖励, 祝您好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>您在本页面可以操作共享的环签名数据库.  Italo 钱包以及复制了 Italo 密钥的克隆钱包都将使用本数据库.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了掩盖Italo交易中任何付款的去向, 第三方不应知道环签名中每个输入和支付的对应关系. 否则就会削弱环签名提供的保护. 如果仅有一个输入之外的所有输入都已知, 那么所有付款的去向将变得透明, 这将使作为Italo三个主要隐私保护层之一的环签名彻底无效.  &lt;br&gt; 为帮助交易中避免出现这些问题, 可以使用已知去向列表来避免在新交易中使用它们.  这个清单由 Italo 项目维护, 可在 getitalo.org 网站上找到, 您可以在此处导入此清单. &lt;br&gt; 或者, 您可以自己扫描区块链 (以及复制了 Italo 密钥的克隆钱包的区块链),  使用italo-blockchain-mark-spent-outputs工具创建已知已用输出的列表. &lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>就快完成了 - Italo 还需要一点设置</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Italo blockchain?</source>
        <translation>开始同步 Italo 区块链?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>硬盘节约模式能精简区块链的数据而减少硬盘空间的使用量, 但保存完整的区块链能加强 Italo 网络的安全性, 当您需要在容量较小的硬盘上执行, 那么这个功能就很适合您, 此功能对于网络带宽的用量没有影响. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>启动挖矿功能可让 Italo 的系统网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>为了能与Italo网络进行通讯, 您的钱包需要连接上一个Italo节点. 为了获得最好的隐私, 我们建议您运行一个自己的节点 &lt;br&gt;&lt;br&gt; 如果您无法运行自己的节点, 可以选择连上一个远程的节点. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Italo的开发完全由捐赠所支持</translation>
    </message>
    <message>
        <location filename="../wizard/WizardDonation.qml" line="113"/>
        <source>Enable auto-donations of?</source>
        <translation>激活自动捐赠给Italo的开发团队?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一笔交易中 Italo 系统都会收取小额的手续费, 而这个选项则是让你可以增加额外的金额捐赠 Italo 的开发, 比例以当次交易的手续费为基础计算, 譬如 50% 的自动捐赠意味着如果转账手续费为 0.005XMR时将会额外捐赠 0.0025 XMR 给 Italo 开发团队. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Italo network, and also pays a small reward for the work done. This option will let Italo mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>启动挖矿功能可让 Italo 的网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>使用 ITALO</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>欢迎使用 Italo！</translation>
    </message>
    <message>
