...
<context>
    ...
    <message>
        ...
        <source>WARNING: Do not reuse your Italocoin keys on another fork, UNLESS this fork has key reuse mitigations built in. Doing so will harm your privacy.</source>
        <translation>AVERTENCIA: No reuses tus llaves en otra bifurcación the Italocoin, A NO SER que esta bifurcación tenga incorporado las mitigaciones para el reuso de las llaves. Hacerlo perjudicará tu privacidad.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Minar con tu computadora ayuda a fortalecer la red de Italocoin. Entre más gente mine, más difícil será atacar la red, por lo que cada pequeño esfuerzo cuenta.&lt;br&gt; &lt;br&gt;Minar también te da una pequeña oportunidad de ganar algún Italocoin dado que el equipo generará una serie de operaciones (hashes) para tratar de añadir nuevos bloques. Si encuentras un bloque, obtendrás una recompensa por ese trabajo. ¡Buena suerte!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>With more Italocoin</source>
        <translation>Con más Italocoin</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Italocoin</source>
        <translation>Sin Italocoin suficientes</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Versión embedida de Italocoin: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Uses a third-party server to connect to the Italocoin network. Less secure, but easier on your computer.</source>
        ...
        <translation>Utiliza un servidor de un tercero para conectarse a la red de Italocoin. Es menos seguro, pero más sencillo para tu computadora.</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsNode.qml" line="277"/>
        <source>To find a remote node, type &apos;Italocoin remote node&apos; into your favorite search engine. Please ensure the node is run by a trusted third-party.</source>
        <translation>Para encontrar un nodo remoto, escribe &apos;nodo remoto Italocoin&apos; en tu motor de búsqueda favorito. Por favor asegúrate de que el nodo se ejecute por un tercero confiable.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by Italocoin wallets as well as wallets from Italocoin clones which reuse the Italocoin keys.</source>
        <translation>Esta página permite interactuar con la base de datos de las firmas circulares compartidas. Esta base de datos es para uso de los monederos de Italocoin como también por los monederos de los clones de Italocoin que han reusado las claves.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to obscure which inputs in a Italocoin transaction are being spent, a third party should not be able to tell which inputs in a ring are already known to be spent. Being able to do so would weaken the protection afforded by ring signatures. If all but one of the inputs are known to be already spent, then the input being actually spent becomes apparent, thereby nullifying the effect of ring signatures, one of the three main layers of privacy protection Italocoin uses.&lt;br&gt;To help transactions avoid those inputs, a list of known spent ones can be used to avoid using them in new transactions. Such a list is maintained by the Italocoin project and is available on the getitalocoin.org website, and you can import this list here.&lt;br&gt;Alternatively, you can scan the blockchain (and the blockchain of key-reusing Italocoin clones) yourself using the italocoin-blockchain-mark-spent-outputs tool to create a list of known spent outputs.&lt;br&gt;</source>
        <translation>Para poder ofuscar qué entradas han sido gastadas en las transacciones de Italocoin, un tercero no debería poder determinar de las firmas circulares cuales han sido gastadas en esas entradas. Hacerlo debilitaría la protección que proporcionan las firmas. Si solo una de las entradas pudiera ser determinada en el gasto, entonces esa entrada se vuelve evidente, anulando el efecto de las firmas. Las firmas circulares son una de las capas principales que usa Italocoin para proteger la privacidad.&lt;br&gt;Para evitar que las transacciones usen estas entradas, puede ser usada una lista de entradas gastadas para evitar usarlas en nuevas transacciones. Esa lista es mantenida por el proyecto Italocoin y está disponible en la página web getitalocoin.org y la puedes importar desde aquí.&lt;br&gt;De lo contrario, puede escanear la cadena de bloques (y las cadenas de bloques de los clones de Italocoin que reusan las claves) usted mismo usando la herramienta de Italocoin de salidas excluidas para crear una lista conocida de las salidas gastadas.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by Italocoin&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing Italocoin clone allows you to spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by Italocoin and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing Italocoin clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your Italocoin safely.&lt;br&gt;If you do not use a key-reusing Italocoin clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Para evitar anular la protección que brindan las firmas de circulo que ofrece Italocoin, un output no debe gastarse en diferentes blockchains con diferentes firmas. Aunque esto normalmente no es una preocupación, puede convertirse en una cuando un clon de Italocoin, que reusa las llaves, permite gastar ese output nuevamente. Si este es el caso, debes asegurar ese output use las mismas firmas de circulo en ambas cadenas.&lt;br&gt;Esto será realizado por Italocoin y cualquier aplicación de reuso de llaves que no este activamente tratando de estropear tu privacidad.&lt;br&gt;Si estas usando un clon de Italocoin que reuse las llaves y este clon no incluya esta protección, puedes asegurar la protección de las transacciones si gastas primero en el clon. Luego agrega manualmente la firma de anillo en esta página, que te permitirá gastar tus Italocoin de manera segura.&lt;br&gt;Si no utilizas un clon de Italocoin con estas características, entonces no debes hacer nada, ya que esto se hará de manera automática.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="285"/>
        <source>This records rings used by outputs spent on Italocoin on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Esto registra las firmas salientes en cadenas que reusan las claves de Italocoin, de manera que la misma firma pueda ser reusada para evitar inconvenientes de privacidad.</translation>
    </message>
    <message>
...
Tamaño de la firma circular: </translation>
    ...
    <message>
        ...
        <source>Italocoin sent successfully</source>
        <translation>Italocoin enviado con exito</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>¿Arrancar la cadena de bloques de Italocoin?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>La minería asegura la red de Italocoin y además paga una pequeña recompensa por el trabajo realizado. Esta opción permite que Italocoin mine mientras su computadora está ociosa. La Minería se detendrá cuando continúe trabajando con ella.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Para poderse conectar con la red de Italocoin, su monedero necesita estar conectado a un nodo de Italocoin. Para mayor privacidad, es recomendable que ejecute su propio nodo.                         &lt;br&gt;&lt;br&gt;                         Si no tiene la opción de iniciar su propio nodo, esta la opción de hacer uso de un nodo remoto.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>El desarrollo de Italocoin es soportado exclusivamente por donaciones</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Por cada transacción, se carga una pequeña comisión. Esta opción le permite añadir una cantidad adicional, como porcentaje de esta comisión, para dar apoyo a Italocoin. Por ejemplo, una autodonación del 50% de una comisión de 0.005 XMR añade 0.0025 XMR para apoyar el desarrollo de Italocoin.</translation>
    </message>
    <message>
...
Comisión: </translation>
    ...
    <message>
        <location filename="../main.qml" line="800"/>
        <source>Italocoin sent successfully: %1 transaction(s) </source>
        <translation>Italocoin enviado con exito: %1 transacción(es)</translation>
    </message>
    <message>
