...
<context>
    ...
    <message>
        ...
        <translation>Italocoin 多於預期金額</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Italocoin</source>
        <translation>Italocoin 少於預期金額</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用第三方的遠端節點以連接到 Italocoin 網路，較不安全，但簡易使用。</translation>
    </message>
    <message>
        ...
        <translation>如果需要遠端節點，上網搜尋「 Italocoin 遠端節點 」。請確認該節點是由可信任的第三方所架設。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>本頁面可以讓你對共享環簽資料庫進行操作，這個資料庫可以讓 Italocoin 錢包與其重複使用金鑰的分叉幣錢包共享環簽資訊。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了要混淆 Italocoin 真實被花用過的交易輸入，第三方不應能得知在環簽內的交易組合中哪一個交易是已經被花用的，否則環簽的保護效果將被減弱。若被觀察出只有一個交易輸出是尚未被花用的則該筆交易的來源將會變得顯而易見，也就等於損失了 Italocoin 的三大保護隱私保護其中之一: 環狀簽名。&lt;br&gt;若要避免發生這類狀況，一個已知被花用的交易輸出名單可以用來避免在新的交易中使用到這些輸出，此份名單是由 Italocoin 專案所維護，可以在 getitalocoin.org 網站上找到並在此匯入。&lt;br&gt;或是你可以選擇使用 italocoin-blockchain-mark-spent-outputs tool 自行掃描區塊鏈(與重複使用金鑰的分叉幣區塊鏈)以產生該份名單。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了避免讓 Italocoin 的環狀簽名保護失效，一個交易輸出應避免在不同的區塊鏈中以不同的環簽組合所花用。這通常不需要擔心，但當你在重複使用金鑰的分叉幣區塊鏈上花用現有的交易輸出時就得注意，必需在兩條鏈上使用相同的環簽組合。&lt;br&gt;這個保護措施在Italocoin或其他注重保護你的隱私的軟體中重複使用金鑰時都應是自動完成的。&lt;br&gt;如果你正在使用重複使用金鑰的分叉幣且該幣並未包含此保護措施，你必須先於分叉幣上花用交易，再將環簽在此匯入以確保您的Italocoin交易隱私安全。&lt;br&gt;若你沒有使用未經保護的分叉幣則不須任何處置，因為這保護措施將會自動完成。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>這記錄著在 Italocoin 鏈上所使用過的環狀簽名組合，因此相同組合應在重複金鑰的分叉鏈上沿用以確保隱私安全。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Italocoin 發送成功</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Italocoin 的開發完全由贊助所支持</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一筆交易中 Italocoin 系統都會收取小額的手續費，而這個選項則是讓你可以增加額外的金額贊助 Italocoin 的開發，比例以當次交易的手續費計算，譬如 50% 的自動贊助將會從0.005 XMR的手續費算出 0.0025 XMR 的金額贊助給 Italocoin 開發團隊。</translation>
    </message>
    <message>
...
轉出位址索引: </translation>
    ...
    <message>
        ...
        <translation>Italocoin發送成功: %1 筆交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>這個位址已收到 %1 Italocoin 幣，但這筆交易尚未被礦工確認</translation>
    </message>
    <message>
